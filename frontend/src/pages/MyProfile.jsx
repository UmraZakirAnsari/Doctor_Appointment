...
const MyProfile = () => {
  ...
  return userdata && (
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className='mt-10 '>{
        isEdit
          ? <button className='border border-primary px-8 py-2 rounded-full hover:text-white  hover:bg-primary transition-all ' onClick={updateUserProfileData} >Save Information</button>
